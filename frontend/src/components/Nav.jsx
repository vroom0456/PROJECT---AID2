...
// ── AUTH DISABLED ─────────────────────────────────────────────────────────────
// signOutUser, user store, and profile/logout buttons are commented out.
// Re-enable when Supabase auth is reconnected.
// ─────────────────────────────────────────────────────────────────────────────
// import { useUserStore } from "../store/useStore";
// import { signOutUser } from "../services/authService";

export default function Nav() {
  // const user = useUserStore((s) => s.user);   // AUTH DISABLED
    ...
    <>
      <nav id="navbar" role="navigation" aria-label="Main navigation">
        ...
        <div className="nav-acts">
          ...
          {/* Profile button DISABLED — auth inactive */}
          {/* <div className="profile-btn-wrap hide-mob"> ... </div> */}
      ...
      >
        ...
        {/* Logout button DISABLED — auth inactive */}
        {/* <button onClick={() => { closeMenu(); signOutUser(); }} style={{ color: "var(--red)" }}>Logout</button> */}
      </div>
    </>
  );
}
